...
var getChangeData = function(){
    ...
    if (isJumpLay(json)) {
        ...
        var apibyconfData = {};
        apibyconfData.json = json;
        apibyconfData.schemaRefs = editor.options.schemaRefs;
        document.getElementById("generator-conf").value = JSON.stringify(apibyconfData);// the options
    }
}

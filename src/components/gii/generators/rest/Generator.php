...
namespace myzero1\apibyconf\components\gii\generators\rest;
...
//        $this->moduleClass = sprintf('app\modules\%s\%s', $this->moduleID, 'apibyconfModule');
...
//        $modulePath = $this->getModulePath();
    ...
    public function getModuleTemplateParams()
    {
        ...
        $params['apibyconfAuthenticator'] = $this->confAarray['json']['mySecurity']['security'];
        // var_dump($this->confAarray['json']['mySecurity']['exclude']);exit;
        $params['apibyconfUnAuthenticateActions'] = $this->confAarray['json']['mySecurity']['exclude'];

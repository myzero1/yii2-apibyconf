...
namespace myzero1\apibyconf\components\gii;
...
class Module extends \yii\base\Module implements BootstrapInterface
{
    ...
    public $controllerNamespace = 'myzero1\apibyconf\components\gii\controllers';
    /**
    ...
    protected function coreGenerators()
    {
        return [
            ...
            'rest' => ['class' => 'myzero1\apibyconf\components\gii\generators\rest\Generator'],
        ];
    }

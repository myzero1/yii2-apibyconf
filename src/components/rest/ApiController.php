...
{
    public $apiActionClass = '\myzero1\apibyconf\components\rest\ApiAction';
    public $modelClass = '';
    public $optional = [
        'login',
        'join',
    ...
    public function behaviors()
    {
        ...
        $securityKey = Yii::$app->params['apibyconfAuthenticator_' . $moduleName];
        ...
        if ($securityKey != 'noAuthenticator') {
            ...
            $unAuthenticateActions = Yii::$app->params['apibyconfUnAuthenticateActions_' . $moduleName];
